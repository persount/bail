...
<!-- WhatsApp Links -->
<p>
  <a href="https://whatsapp.com/channel/0029Vb63boPKwqSWJP2Ny03J">
    <img src="https://img.shields.io/badge/WhatsApp-Channel-25D366?logo=whatsapp" alt="WA Official Channel "/>
  </a>
  <a href="https://chat.whatsapp.com/FELZ-AR-OFFICIAL/EiVYCFjGGv1KnwmQDVaVPi">
    <img src="https://img.shields.io/badge/WhatsApp-Group-25D366?logo=whatsapp" alt="WA Official Group "/>
  </a>
  <a href="https://wa.me/6283875184244">
    <img src="https://img.shields.io/badge/FELZ-Owner-32AFED?logo=whatsapp" alt="Owner Number"/>
  </a>
  <a href="https://wa.me/6285876500334?text=Menu">
    <img src="https://img.shields.io/badge/FELZ-Number-32AFED?logo=whatsapp" alt="FELZ-AR Number"/>
  </a>
  <a href="https://instagram.com/kang_farrel12">
    <img src="https://img.shields.io/badge/Instagram-Official-C13584?logo=instagram" alt="Instagram Official"/>
  </a>
</p>
...
await sock.sendMessage(
   jid,
   {
       ...
       thumbnail: Buffer, // Buffer or null
       productList: [{
...
await sock.sendMessage( 
    jid, 
    { 
       text: 'Information details', // This string is required. Even it's empty. 
       interactiveButtons: [ 
          { 
             name: 'payment_info', 
             buttonParamsJson: JSON.stringify({ 
                payment_settings: [{ 
                   ...
                   pix_static_code:  { 
                      merchant_name: 'FELZ-AR', 
                      key: 'example@felz.com', 
       ...
       interactiveButtons: [ 
          { 
             ...
             buttonParamsJson: JSON.stringify({ 
                ...
                additional_note: 'Add notes to other information', 
